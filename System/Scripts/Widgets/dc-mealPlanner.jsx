...
function MealPlanner() {
    ...
    const DayCard = ({ day }) => {
        ...
        return (
            <div style={{ background: showBackgrounds ? colors.surface : "transparent", borderRadius: 10, border: showBackgrounds ? `1px solid ${colors.primary}22` : "none", overflow: "hidden", display: "flex", flexDirection: "column" }}>
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: 16, padding: 16, background: showBackgrounds ? colors.surface : "transparent", borderRadius: 12, border: showBackgrounds ? `1px solid ${colors.primary}33` : "none", color: colors.text }}>
